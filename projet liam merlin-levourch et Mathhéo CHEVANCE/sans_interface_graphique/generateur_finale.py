...
from prog_dico import dictionnaire

#matthéo
def generateur_mdp(dico, nb_lettre):         #on prend en entrer le nb de lettre par mot du mdp
  """in : le dictionnaire et le nombre de lettre de chaque mot géneré
  out : le mot de passe prononcable (altérnance , voyelle / consonne) et aléatoire """
